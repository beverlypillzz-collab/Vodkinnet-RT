...
Скрипт:
1. Проверяет наличие podkop и выводит предупреждение если найден
2. Устанавливает `adblock` + `luci-app-adblock`
3. Применяет podkop-safe конфиг
4. Запускает сервис
